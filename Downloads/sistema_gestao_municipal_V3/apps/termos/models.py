...
class Termos(models.Model):
    ...
    nomeintermediario = models.CharField(max_length=100, blank=True, null=True,
                                         verbose_name='Nome Intermediário')
    nomesecretario = models.CharField(max_length=100, blank=True, null=True, verbose_name='Nome Secretário(a)')
    nomerepresentante = models.CharField(max_length=100, blank=True, null=True,
                                         verbose_name='Nome Representante')

    #new Fields - Controle de Parcerias#
    ...
    filePlanoTrabalho = models.FileField(upload_to='prestacao_photos', blank=True, null=True,
                                         verbose_name='Planos de Trabalho')
    ...
    # prestacao = models.ManyToManyField(Prestacao)

    def get_absolute_url(self,):
        return reverse('list_termos')
